...
This site lives in the [`docs`](https://github.com/Canadian-Severe-Storms-Laboratory/docs) repository and is built with Astro. Each page is an MDX file under `src/content/docs/`, and its path sets the URL: `src/content/docs/raindrop/alerts.mdx` becomes `/raindrop/alerts`.
