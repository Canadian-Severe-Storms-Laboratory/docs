...
Scheduled polls run on the clock (for example :00, :20 and :40 for a 20-minute feed), not at intervals measured from startup. Values are converted to [standard units](/raindrop/observations#units) on arrival.
...
Every Raindrop observation carries a [quality flag](/raindrop/observations#quality-flags).
